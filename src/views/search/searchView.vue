...
<template>
    <el-header>
        ...
        <el-input ref="searchInput" v-model="searchStore.search" style="width:257px;height:32px;font-size: 18px;color:#BBB6B6;" placeholder="搜获帖子、活动或用户" class="search-input" size="default" @keyup.enter="handleSearch(); searchInput.blur()">
            <template #prefix>
            ...
            <template #suffix>
                <div v-show="searchStore.search != ''" class="clean">
                    <svg @click="handleClean" width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">

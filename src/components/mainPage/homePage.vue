...
import Map from '@/components/mainPage/homePage/cultureMap.vue'
import Advice from '@/components/mainPage/homePage/advice.vue';
import Sort from '@/components/mainPage/homePage/sort.vue';

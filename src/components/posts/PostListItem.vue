...
<template>
    <el-skeleton :loading="loading" animated>
            ...
            <div class="post-list-item" v-if="post">
                <div class="post-item">
                    ...
                    <div class="item-content" @click="gotoPost(post.id)">
                        ...
                        <el-image class="content-img" v-if="post.urls?.length" :src="post.urls[0].url"
                            :preview-src-list="[post.urls[0].url]" fit="cover" @click.stop="" />
                    </div>
                            ...
                            <div class="comment">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#766552" stroke-width="2" stroke-linecap="round"
        ...
        <template #template>
            ...
            <el-skeleton-item variant="image" style="width: 128px; height: 72px;" />
